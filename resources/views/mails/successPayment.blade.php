                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            ...
                                                            <img height="auto" src="assets/images/logo/Simposium.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="64" />
                                        ...
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:left;color:#525252;">
                                                <p>
                                                    ...
                                                    Terima kasih pula atas pembayaran yang telah Anda lakukan. Kontribusi Anda sangat berarti bagi kelancaran dan keberhasilan kegiatan ini. Dukungan Anda telah membantu kami mewujudkan pengalaman yang luar biasa bagi semua peserta.
                                                    <br>
                                                    <br>
                                                    Semoga acara ini memberikan manfaat positif dan pengalaman berharga bagi Anda. Kami berharap dapat bertemu dan bekerja sama lagi dalam kesempatan mendatang.
                                                </p>
                                            </div>
                                        ...
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]" border="0" style="cellspacing:0;color:#000;font-family:'Helvetica Neue',Arial,sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;">
                                                <tr style="border-bottom:1px solid #ecedee;text-align:left;">
                                                    <th style="padding: 0 15px 10px 0;">Acara</th>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;line-height:16px;text-align:left;color:#a2a2a2;">
                                                <p>
                                                    Kami berharap acara ini membawa pengalaman berharga bagi Anda. Terima kasih atas partisipasi dan pembayaran Anda. Semoga Anda menikmati setiap momen dalam kegiatan kami.
                                                </p>    
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                Hormat Kami,<br><a href="https://www.htmlemailtemplates.net" style="color:#2F67F6">Simposium Manado</a>
                                            </div>
