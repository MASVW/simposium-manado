                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <div
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <h6>{{ $event->events->eventDate }}</h6>
                                    <h2>{{ $event->events->eventName }}</h2>
                                    <p>{{ $event->events->excerpt }}</p>
                                </div>
                                <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <div
                            ...
                            data-wow-delay="0.5s">
                            @if($event->events->img)
                            <img src="{{ asset('./storage/events-images/' . $event->events->img)}}" alt="Simposi">
                            @else
            ...
            <div class="col-lg-7 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                <div class="blog-post">
                    ...
                    <div class="down-content">
                        <span class="category">{{$event->events->slug}}</span>
                        <span class="date">{{$event->events->eventDate}}</span>
                        <h4>{{$event->events->eventName}}</h4>
                        <div class="position-relative mt-2 overflow-auto" style="height: 400px;">
                            <p>{{ $event->events->eventDesc }}</p>
                        </div>
                        @auth
                        <span>
                    ...
                    <div class="thumbs">
                        <div class="col-lg-12">
                            <div class="post-item">
                                ...
                                <form action="/tag={{$event->events->slug}}/price" method="POST" style="align-items: center;">
                                    @CSRF
